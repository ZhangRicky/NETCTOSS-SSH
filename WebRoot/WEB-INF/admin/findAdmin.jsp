        ...
        <div id="main">
            <form action="findAdmin" method="post" id="findForm">
                ...
                <div class="search_add">
                    ...
                    <div>
                       	 模块：
                       	<s:select name="privilegeId" list="privileges" listKey="id" listValue="name" cssClass="select_search" headerKey="" headerValue=""></s:select>
                    </div>
                    <div>
                    	角色：
                    	<s:select name="roleId" list="roles" listKey="id" listValue="name" cssClass="select_search" headerKey="" headerValue=""></s:select>
                    </div>
